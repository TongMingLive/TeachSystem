                ...
                if (TextUtils.isEmpty(name)) {
                    ...
                    new Thread() {
                        ...
                        public void run() {
                            ...
                            String str = HttpUtil.doPost(HttpUtil.path + "SelectUserNumberServlet", map);
                            Log.e("register", str);
                            if ("error".equals(str)) {
                                Log.e("login", "isNot");
                                ...
                                String updateStr = HttpUtil.doPost(HttpUtil.path + "UpdateUserPasswordServlet", map);
                                if ("true".equals(updateStr)){
    ...
    Handler handler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            if (msg.what == 0x123) {
                ...
                Snackbar.make(register, "未检测到该学号，请仔细核对学校分配给你的学号", Snackbar.LENGTH_LONG).show();
            } else if (msg.what == 0x125) {
                Snackbar.make(register, "老师请在jsp端登陆后台", Snackbar.LENGTH_LONG).show();
